                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Text(
                                                    'Send ${bottomNavigationController.astrologerbyId[0].name} a Gift'),
                                                InkWell(
                                                    onTap: () {
                                                      Get.back();
                                                    },
                                                          ...
                                                          backgroundColor:
                                                              MaterialStateProperty.all(
                                                                  Colors.grey
                                                                      .shade100),
                                                          shape: MaterialStateProperty.all<RoundedRectangleBorder>(
                                                              RoundedRectangleBorder(borderRadius: BorderRadius.circular(10), side: BorderSide(color: Colors.black12)))),
                                                      onPressed: () async {
                                                        if (giftController
                                                                .giftSelectIndex !=
                                                            null) {
