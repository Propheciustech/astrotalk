            ...
            children: [
              GetBuilder<CallController>(builder: (c) {
                return TabBar(
                  ...
                  unselectedLabelStyle: Get.theme.primaryTextTheme.subtitle1!
                                                              ...
                                                              child: Column(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Row(
                                                                    ...
                                                                    children: [
                                                                      Icon(
                                                                        historyController.paymentLogsList[ind].paymentStatus == "failed" ||
                                                                                historyController.paymentLogsList[ind].paymentStatus == "Failed"
                                                                            ? Icons.error
                                                                            : Icons.check_circle,
                                                                        size:
                                                                            13,
                                                                        color: historyController.paymentLogsList[ind].paymentStatus == "failed" ||
                                                                                historyController.paymentLogsList[ind].paymentStatus == "Failed"
                                                                            ? Colors.red
                                                                            : Colors.green,
                                                                      ),
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Container(
                                                                            ...
                                                                            width:
                                                                                65,
                                                                            decoration:
                                                                                BoxDecoration(borderRadius: BorderRadius.circular(7), border: Border.all(color: Get.theme.primaryColor)),
                                                                            child:
                                                                                CircleAvatar(
                                                                              radius: 35,
                          ...
                          : callController.tabController!.index == 2
                                              ...
                                              child: ListView.builder(
                                                ...
                                                itemBuilder: (context, index) {
                                                  return GestureDetector(
                                                    onTap: () async {
                                                      print(
                                                          'firebase ChatID ${historyController.chatHistoryList[index].chatId!}');
                                                      ChatController
                                                          chatController =
                                                          Get.find<
                                                              ChatController>();
                                                                ...
                                                                Row(
                                                                  ...
                                                                  children: [
                                                                    Column(
                                                                      ...
                                                                      children: [
                                                                        Text(
                                                                            '${global.formatter.format(historyController.chatHistoryList[index].createdAt!)}'),
                                                                        Text(
                                                                          historyController
                                                                        ...
                                                                        GestureDetector(
                                                                          onTap:
                                                                            ...
                                                                            global.showOnlyLoaderDialog(context);
                                                                            chatController.shareChat(historyController.chatHistoryList[index].chatId ?? '',
                              ...
                              : callController.tabController!.index == 3
                                  ? GetBuilder<HistoryController>(
                                      ...
                                      return Column(children: [
                                        historyController
                                                .astroMallHistoryList.isNotEmpty
                                            ? Container(
                                                height: Get.height - 197,
                                                child: RefreshIndicator(
                                                  onRefresh: () async {
                                                                      ...
                                                                      Column(
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Text(
                                                                            ...
                                                                            style:
                                                                                Get.textTheme.bodyText2!.copyWith(color: Colors.grey, fontSize: 13),
                                                                          ),
                                                                          Row(
                                                                            children: [
                                                                              Text(
                                                          ...
                                                          itemBuilder:
                                                            ...
                                                            return Column(
                                                              children: [
                                                                ...
                                                                historyController.reportMoreDataAvailable ==
                                                                            true &&
                                                                        !historyController
                                                                            .reportAllDataLoaded &&
                                                                        historyController.reportHistoryList.length -
                                                                                1 ==
                                                                            index
                                                                    ? const CircularProgressIndicator()
                                                                    : const SizedBox(),
