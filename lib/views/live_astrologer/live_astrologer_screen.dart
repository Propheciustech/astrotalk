                  ...
                  children: [
                    ...
                    bottomNavigationController.anotherLiveAstrologers.isEmpty
                        ? Expanded(
                            ...
                            child: Container(
                              child: Center(
                                child: Text("No Astrologer available"),
                              ),
                            ),
                          )
                        : Expanded(
      ...
      child: SafeArea(
          child: Scaffold(
              body: isHostJoin
                                                            ...
                                                            Get.dialog(
                                                              AlertDialog(
                                                                ...
                                                                content:
                                                                  ...
                                                                  children: [
                                                                    Text(
                                                                        '1. Donation is a virtual gift.'),
                                                                    const SizedBox(
                                                                      height:
                                                                          10,
                                                                    ),
                                                                    Text(
                                                                        '2. Donation is a valuntary & non-refundable.'),
                                                                    const SizedBox(
                                                                      height:
                                                                          10,
                                                                    ),
                                                                    Text(
                                                                        '3. Company doesn\'t guarantee any service in exchage of donation.'),
                                                                    const SizedBox(
                                                                      height:
                                                                          10,
                                                                    ),
                                                                    Text(
                                                                        '4. Donation can be encashed by the astrologer in monetary terms as per company policies.'),
                                                                  ],
                                                                ),
                                                              ),
                                                            );
                  ...
                  : Center(
                      child: Text('Astrologer is not live yet!'),
                    ))),
    );
  }
