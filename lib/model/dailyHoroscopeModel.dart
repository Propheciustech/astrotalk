class DailyHororscopeModel {
  ...
  DailyHororscopeModel.fromJson(Map<String, dynamic> json) {
    ...
    horoscopeDate = DateTime.parse(
        json["horoscopeDate"] ?? DateTime.now().toIso8601String());
  ...
  DailyscopeModel.fromJson(Map<String, dynamic> json) {
    try {
      todayHoroscope = json['todayHoroscope'] != null
          ? List<DailyHororscopeModel>.from(json['todayHoroscope']
              .map((p) => DailyHororscopeModel.fromJson(p)))
          : [];
      yeasterDayHoroscope = json["yeasterDayHoroscope"] != null
          ? List<DailyHororscopeModel>.from(json['yeasterDayHoroscope']
              .map((p) => DailyHororscopeModel.fromJson(p)))
          : [];
      tomorrowHoroscope = json["tomorrowHoroscope"] != null
          ? List<DailyHororscopeModel>.from(json['tomorrowHoroscope']
              .map((p) => DailyHororscopeModel.fromJson(p)))
          : [];
      todayInsight = json["todayInsight"] != null
          ? List<DailyHororscopeModel>.from(
              json['todayInsight'].map((p) => DailyHororscopeModel.fromJson(p)))
          : [];
      yeasterdayInsight = json["yeasterdayInsight"] != null
          ? List<DailyHororscopeModel>.from(json['yeasterdayInsight']
              .map((p) => DailyHororscopeModel.fromJson(p)))
          : [];
      tomorrowInsight = json["tomorrowInsight"] != null
          ? List<DailyHororscopeModel>.from(json['tomorrowInsight']
              .map((p) => DailyHororscopeModel.fromJson(p)))
          : [];
      weeklyHoroScope = json["weeklyHoroScope"] != null
          ? List<DailyHororscopeModel>.from(json['weeklyHoroScope']
              .map((p) => DailyHororscopeModel.fromJson(p)))
          : [];
      monthlyHoroScope = json["monthlyHoroScope"] != null
          ? List<DailyHororscopeModel>.from(json['monthlyHoroScope']
              .map((p) => DailyHororscopeModel.fromJson(p)))
          : [];
      yearlyHoroScope = json["yearlyHoroScope"] != null
          ? List<DailyHororscopeModel>.from(json['yearlyHoroScope']
              .map((p) => DailyHororscopeModel.fromJson(p)))
          : [];
      todayHoroscopeStatics = json["todayHoroscopeStatics"] != null
          ? List<HoroscopeStatic>.from(json['todayHoroscopeStatics']
              .map((p) => HoroscopeStatic.fromJson(p)))
          : [];
      yeasterdayHoroscopeStatics = json["yeasterdayHoroscopeStatics"] != null
          ? List<HoroscopeStatic>.from(json['yeasterdayHoroscopeStatics']
              .map((p) => HoroscopeStatic.fromJson(p)))
          : [];
      tomorrowHoroscopeStatics = json["tomorrowHoroscopeStatics"] != null
          ? List<HoroscopeStatic>.from(json['tomorrowHoroscopeStatics']
              .map((p) => HoroscopeStatic.fromJson(p)))
          : [];
    } catch (e) {
...
class HoroscopeStatic {
  ...
  factory HoroscopeStatic.fromJson(Map<String, dynamic> json) =>
      HoroscopeStatic(
        id: json["id"],
        horoscopeSignId: json["horoscopeSignId"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "horoscopeSignId": horoscopeSignId,
        "horoscopeDate":
            horoscopeDate != null ? horoscopeDate!.toIso8601String() : null,
        "luckyTime": luckyTime,
